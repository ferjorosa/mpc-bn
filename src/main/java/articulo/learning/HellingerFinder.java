...
import voltric.learning.structure.hillclimbing.operator.DecreaseLatentCardinality;
...
public class HellingerFinder {
    ...
    private static HLCM formBestLCM(DiscreteData data, AbstractEM em, List<DiscreteVariable> currentVariables, Map<DiscreteVariable, Map<DiscreteVariable, Double>> pairValues) {
        ...
        HLCM lcm2Vars = (HLCM) HiddenNaiveBayes.learnModel(maxCardinality, data.project(bestVariables), em, thresholdParaEM).getBayesianNetwork();
    ...
    private static HLCM increaseAndDecreaseCardinality(DiscreteData data, AbstractEM em, HLCM lcm) {
        ...
        GeneralHillClimbing hillClimbingIncrease = new GeneralHillClimbing(ilcOperatorSet, 500, thresholdParaEM);
        ...
        GeneralHillClimbing hillClimbingDecrease = new GeneralHillClimbing(dlcOperatorSet, 500, thresholdParaEM);
