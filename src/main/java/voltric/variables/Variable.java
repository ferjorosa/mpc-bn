...
public abstract class Variable implements IVariable, Comparable<Variable>{
    ...
    /** The variable's identifier. It is an index that represents its creation order. It is used just for ordering. */
    protected int index;
    ...
    /**
     * Returns true if <code>object</code> is a <code>Variable</code> instance with the same type and name.
     *
