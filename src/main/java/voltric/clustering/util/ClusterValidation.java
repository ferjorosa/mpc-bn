...
public class ClusterValidation {
    ...
    public static double calculateNormalizedUniformBrierScore(List<SymmetricPair<DiscreteDataInstance, double[]>> clusteringAssignments, DiscreteData data, int cardinality) {
        ...
        for(SymmetricPair<DiscreteDataInstance, double[]> assignment: clusteringAssignments)
    ...
    public static List<Double> calculateNormalizedBrierScores(List<SymmetricPair<DiscreteDataInstance, double[]>> clusteringAssignments, DiscreteData data, List<Integer> cardinalities) {
