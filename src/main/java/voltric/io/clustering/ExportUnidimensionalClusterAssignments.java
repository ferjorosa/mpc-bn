...
public class ExportUnidimensionalClusterAssignments {
    ...
    public static void export(DiscreteData data, List<SymmetricPair<DiscreteDataInstance, double[]>> assignments, String filePathString) throws IOException {
        ...
        for (SymmetricPair<DiscreteDataInstance, double[]> assignment: assignments)
