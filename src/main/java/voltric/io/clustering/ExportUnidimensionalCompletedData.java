...
public class ExportUnidimensionalCompletedData {
    ...
    public static void export(DiscreteData data,List<SymmetricPair<DiscreteDataInstance, Integer>> partitionClusters, String filePathString, int clusterCardinality, String relationName) throws IOException {
        ...
        for (SymmetricPair<DiscreteDataInstance, Integer> cluster: partitionClusters)
