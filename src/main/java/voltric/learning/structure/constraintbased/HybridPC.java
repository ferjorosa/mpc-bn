...
import voltric.learning.structure.hillclimbing.operator.AddArc;
import voltric.learning.structure.hillclimbing.operator.HcOperator;
import voltric.learning.structure.hillclimbing.operator.RemoveArc;
import voltric.learning.structure.hillclimbing.operator.ReverseArc;
...
public class HybridPC {
    ...
    public LearningResult<DiscreteBayesNet> learnModel(DiscreteData data, DiscreteParameterLearning parameterLearning) {
        ...
        GeneralHillClimbing hillClimbing = new GeneralHillClimbing(operatorSet, this.maxIterationsHC, this.threshold);
