...
public abstract class AbstractBayesNet<L extends AbstractBeliefNode,M extends AbstractBeliefNode>{
    ...
    public AbstractBayesNet(){
        this.name = "Abstract_Bayesian_network";
    ...
    //TODO: Documentation
    public Optional<Edge<Variable>> getEdge(AbstractBeliefNode head, AbstractBeliefNode tail){
        return this.dag.getEdges().stream()
