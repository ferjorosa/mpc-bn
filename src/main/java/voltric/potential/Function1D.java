...
class Function1D extends Function {
    ...
    public final Function times(Function function) {
        ...
        if (function instanceof Function1D && function._variables[0].equals(variable)) { // TODO: 25-10-2017 He cambiado el '==' por equals
            ...
            if (variable.equals(((Function2D) function).varX)) { // TODO: 25-10-2017 He cambiado el '==' por equals
    ...
    public final Function project(DiscreteVariable variable, int state) {
        ...
        // argument variable must be the one involved in this function
        if(!variable.equals(this.variable))
            throw new IllegalArgumentException("Argument variable("+variable+") must be the one involved in this function("+this.variable+")");
